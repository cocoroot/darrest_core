...
describe 'SiteUserHeaderImages', type: :request do
  ...
  # describe 'GET /site_user_header_images/{site_user_header_image_id}' do
  #   before do
  #     create(:site_user_header_image, id: 900_000_001, site_user_id: 900_000_001)
  #   end
  ...
  #     # execute
  #     #
  #     get_by_site(site_user_header_image_path(900_000_001), 900_000_001)
  ...
  #   before do
  #     create(:site_user_header_image, id: 900_000_001, site_user_id: 900_000_001, order: 1, in_use: true)
  #   end
  ...
  #     # execute
  #     #
  #     put_by_site(site_user_header_image_path(900_000_001), 900_000_001, params)
  ...
  #     expect(response.status).to eq 200
  #     result = JSON.parse(response.body)
  #     expect(result['image_name_for_user']).to eq params[:site_user_header_image][:image_name_for_user]
  #     expect(result['order']).to eq params[:site_user_header_image][:order]
  #     expect(result['in_use']).to eq params[:site_user_header_image][:in_use]
  #   end
  # end # PUT
  ...
  #     # execute
  #     #
  #     expect { delete_by_site(site_user_header_image_path(900_000_001), 900_000_001) }.to change { SiteUserHeaderImage.count }.by(-1)      
  #   end
  # end # DELETE
end
