...
describe DeleteCreationImageLogic, type: :logic do
  before(:all) do
  ...
  describe 'authorize' do
    context 'if Site does not exist,' do
      ...
      it 'denies a Creation' do
        ...
        # execute
        #
        result = DeleteCreationImageLogic.new.authorize(params)
  ...
  describe 'validate' do
    context '論理チェックエラー' do
      ...
      it 'returns error' do
        ...
        # exectue
        #
        result = DeleteCreationImageLogic.new.validate(params)
  ...
  describe 'execute' do
    context 'normal condition' do
      it 'creates a Creation' do
        ...
        # execute
        #
        expect{ DeleteCreationImageLogic.new.execute(params) }.to change { CreationImage.count }.by(-1)
      end
    end
  end # execute
end
