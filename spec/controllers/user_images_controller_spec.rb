...
RSpec.describe UserImagesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all user_images as @user_images" do
      ...
      expect(assigns(:user_images)).to eq([user_image])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new user_image as @user_image" do
      ...
      expect(assigns(:user_image)).to be_a_new(UserImage)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new UserImage" do
        expect {
          post :create, {:user_image => valid_attributes}, valid_session
        }.to change(UserImage, :count).by(1)
      end

      it "assigns a newly created user_image as @user_image" do
        post :create, {:user_image => valid_attributes}, valid_session
        expect(assigns(:user_image)).to be_a(UserImage)
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved user_image as @user_image" do
        post :create, {:user_image => invalid_attributes}, valid_session
        expect(assigns(:user_image)).to be_a_new(UserImage)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested user_image" do
        user_image = UserImage.create! valid_attributes
        put :update, {:id => user_image.to_param, :user_image => new_attributes}, valid_session
        user_image.reload
      ...
      it "assigns the requested user_image as @user_image" do
        user_image = UserImage.create! valid_attributes
        put :update, {:id => user_image.to_param, :user_image => valid_attributes}, valid_session
        expect(assigns(:user_image)).to eq(user_image)
      end
    ...
    context "with invalid params" do
      it "assigns the user_image as @user_image" do
        user_image = UserImage.create! valid_attributes
        put :update, {:id => user_image.to_param, :user_image => invalid_attributes}, valid_session
        expect(assigns(:user_image)).to eq(user_image)
      end
